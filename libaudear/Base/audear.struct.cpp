...
AEFILTERCOLLECTION AE_initializeSingleItemFilterCollection ( AEBIQUADFILTER filter )
{
...
AEFILTERCOLLECTION AE_initializeEqualizerFilterCollection ( int samplerate, double bandwidth, AEEQUALIZERPRESET preset )
{
	AEFILTERCOLLECTION filterCollection = {};
	for ( int i = 0; i < 10; ++i )
...
AEFILTERCOLLECTION AE_initializeEqualizerFilterCollectionWithGainDB ( int samplerate, double bandwidth, double * gainDBs )
{
	AEFILTERCOLLECTION filterCollection = {};
	for ( int i = 0; i < 10; ++i )
		filterCollection.filters [ i ] = AE_initializePeakEqFilter ( samplerate, equalizerFrequencies [ i ],
